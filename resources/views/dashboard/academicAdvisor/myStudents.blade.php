            ...
            <div class="row">
                ...
                <div class="row x_title">
                    ...
                    <div class="col-md-5 col-sm-5   form-group pull-right top_search">
                        <form action="{{route('dashboard.studentSearch')}}" method="GET">
...
<div class="col-md-6 col-sm-6 " style="width: 100%">
    ...
    <br>
    <div class="clearfix"></div>
    <p style="color:rgb(120, 141, 151)">you can view each student data</p>
    </div>
    <div class="x_content">
    ...
    <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{ route('dashboard.academicAdvisor.showStudentData',$studentuser->id) }}">   
