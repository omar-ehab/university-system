...
<br>
<div class="clearfix"></div>
<p style="color:rgb(120, 141, 151)">you can view each each student's request and approve or decline them</p>
</div>
<div class="x_content">
...
<tbody>
                ...
                <tr>
                    ...
                    <td><a href="{{ route('dashboard.academicAdvisor.studentPendingRequests',$studentuser->id) }}">   
