...
<div class="col-md-6 col-sm-6 " style="width: 100%">
    ...
    <br>
    <div class="clearfix"></div>
    <p style="color:rgb(120, 141, 151)">You can add courses for next semster, be sure to check with your academic advisor</p>
    </div>
    <div class="x_content">
    ...
    <tbody>
                            ...
                            <tr>
                                ...
                                <button type="button" class="btn btn-info" style="border-style: none" >Add</button>    
				</a></td>
                                </tr>
