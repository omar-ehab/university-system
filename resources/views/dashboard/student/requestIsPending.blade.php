...
<div class="col-md-6 col-sm-6 " style="width: 100%">
    ...
    <div class="x_content">
        ...
        <p style="font-size: 20px">You have successfully added this course, please check with your academic advisor for further information !</p>
    <a href="{{ route('dashboard.student.registerCourses') }}"><button class="btn btn-dark" style="float: right">Go back</button></a>
</div>
</div>
</div>
