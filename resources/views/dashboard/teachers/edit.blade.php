                    ...
                    <form class="form-horizontal form-label-left input_mask" method="post"
                        ...
                        <div class="col-xs-12 form-group">
                            ...
                            <select name="faculty_id" id="faculty" class="form-control @error('faculty') bad @enderror">
                                @foreach($faculties as $faculty)
                                    <option
                                        value="{{ $faculty->id }}" {{ $teacher->department->faculty_id == $faculty->id ? 'selected' : '' }}>{{ $faculty->name }}</option>
                                @endforeach
                            </select>
                            @error('faculty')
                        ...
                        <div class="col-xs-12 form-group">
                            ...
                            <select name="department_id" id="department"
                                ...
                                @foreach(\App\Faculty::where('id', $teacher->department->faculty_id)->first()->departments as $department)
                                    <option
                                        value="{{ $department->id }}" {{ $teacher->department_id == $department->id ? 'selected' : '' }}>{{ $department->name }}</option>
                                @endforeach
                            </select>
                            @error('department')
                            <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="col-xs-12 form-group @error('name') bad @enderror">
                            ...
                            <input type="text" class="form-control" id="name" name="name"
                                   placeholder="Name" value="{{ $teacher->user->name }}">
                        ...
                        <div class="col-xs-12 form-group @error('mobile') bad @enderror">
                            ...
                            <input type="text" class="form-control" id="mobile" name="mobile"
                                   placeholder="Mobile" value="{{ $teacher->user->mobile }}">
                        ...
                        <div class="col-xs-12 form-group">
                            ...
                            <select name="gender" id="gender" class="form-control @error('gender') bad @enderror">
                                <option value="male" {{ $teacher->user->gender == 'male' ? 'selected' : '' }}>Male
                                </option>
                                <option value="female" {{ $teacher->user->gender == 'female' ? 'selected' : '' }}>Female
                                </option>
                            </select>
                            @error('gender')
                            <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="col-xs-12 form-group">
                            ...
                            <select name="nationality" id="nationality"
                                ...
                                <option
                                    value="egyptian" {{ $teacher->user->nationality == 'egyptian' ? 'selected' : '' }}>
                                    Egyptian
                                </option>
                                <option value="other" {{ $teacher->user->nationality == 'other' ? 'selected' : '' }}>
                                    Other...
                                </option>
                            </select>
                            @error('nationality')
                        ...
                        <div class="col-xs-12 xdisplay_inputx form-group">
                            ...
                            <input type="date" class="form-control @error('birth_date') bad @enderror" name="birth_date"
                                   id="birth_date"
                                   aria-describedby="birth_date" value="{{ $teacher->user->birth_date }}">
                            @error('birth_date')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-xs-12 form-group">
                            ...
                            <input type="text" pattern="\d*" minlength="14" maxlength="14"
                                   ...
                                   value="{{ $teacher->user->national_id }}">
                            @error('national_id')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-xs-12 form-group">
                            ...
                            <select name="religion" id="religion" class="form-control @error('religion') bad @enderror">
                                <option value="muslim" {{ $teacher->user->religion == 'muslim' ? 'selected' : '' }}>
                                    Muslim
                                </option>
                                <option
                                    value="christian" {{ $teacher->user->religion == 'christian' ? 'selected' : '' }}>
                                    Christian
                                </option>
                                <option value="other" {{ $teacher->user->religion == 'other' ? 'selected' : '' }}>
                                    Other...
                                </option>
                            </select>
                            @error('religion')
